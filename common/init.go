...
func initConstantEnv() {
	...
	if err := constant.SetErrorLogSkipStatusCodes(GetEnvOrDefaultString("ERROR_LOG_SKIP_STATUS_CODES", "")); err != nil {
		SysError(fmt.Sprintf("failed to parse ERROR_LOG_SKIP_STATUS_CODES: %s", err.Error()))
		_ = constant.SetErrorLogSkipStatusCodes("")
	}
	// 任务轮询时查询的最大数量
